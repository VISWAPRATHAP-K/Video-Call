...
try {
  ...
  if (fs.existsSync(resolvedPath)) {
    ...
    fcmInitialized = true;
    console.log('Firebase Admin SDK successfully initialized for calling features.');
  } else {
    console.warn(`[FCM Config Warning]: Firebase Service Account JSON key was not found at "${resolvedPath}". FCM calling notifications will fail until this is resolved.`);
  }
} catch (error) {
